...
{\ttfamily \#include \char`\"{}scpi\+\_\+uart.\+h\char`\"{}}\newline
...
void \mbox{\hyperlink{scpi__uart_8c_a231b0bd8955930c242a0da8eb078fee6}{scpi\+\_\+uart\+\_\+enable}} ()
...
void \mbox{\hyperlink{scpi__uart_8c_a9e6d59e0e19737f121dfcccfe269a90f}{scpi\+\_\+uart\+\_\+disable}} ()
\begin{DoxyCompactList}\small\item\em function to disable the user uart and configure pins reserved by UART to normal GPIO, set as input. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em function to return the value of hanshake save on uart structure \end{DoxyCompactList}\item 
...
const char $\ast$ \mbox{\hyperlink{scpi__uart_8c_a660614784a2c00bf750b2b78b3fae1f4}{scpi\+\_\+uart\+\_\+get\+\_\+protocol}} ()
...
uint8\+\_\+t \mbox{\hyperlink{scpi__uart_8c_a64d2478f69302269dd2157554ccdd1eb}{scpi\+\_\+uart\+\_\+write\+\_\+data}} (char $\ast$dwrt)
\begin{DoxyCompactList}\small\item\em function to send data to uart without checking to receive data. The last charcater is saved for later. \end{DoxyCompactList}\item 
uint8\+\_\+t \mbox{\hyperlink{scpi__uart_8c_aabf80ce27bfee69f06fb7d0d48d71279}{scpi\+\_\+uart\+\_\+write\+\_\+read\+\_\+data}} (char $\ast$dwrt, char $\ast$dread, size\+\_\+t rsize)
...
\begin{DoxyCompactItemize}
\item 
struct \mbox{\hyperlink{structuser__com}{user\+\_\+com}} \mbox{\hyperlink{scpi__uart_8c_ab5345a6829daaaaf13a7eafc26244b3a}{ucom}}
...
function to return the value of hanshake save on uart structure 

\begin{DoxyReturn}{Returns}
bool return if handshake is enabled or disabled 
\end{DoxyReturn}
\mbox{\Hypertarget{scpi__uart_8c_a660614784a2c00bf750b2b78b3fae1f4}\label{scpi__uart_8c_a660614784a2c00bf750b2b78b3fae1f4}} 
...
\end{DoxyReturn}
$<$ return prtpcol string\mbox{\Hypertarget{scpi__uart_8c_a4a7f811e2dfaf126e4e7d665c1b26a13}\label{scpi__uart_8c_a4a7f811e2dfaf126e4e7d665c1b26a13}} 
...
\begin{DoxyReturn}{Returns}
uint32\+\_\+t timeout vslue in ms 
\end{DoxyReturn}
...
$<$ variable who content the numeric value of chracter number
...
$<$ if no error raized on 3 characters received
...
$<$ return error number\mbox{\Hypertarget{scpi__uart_8c_a8c6e0b0b9a1aaa0c264b072b38aa70fc}\label{scpi__uart_8c_a8c6e0b0b9a1aaa0c264b072b38aa70fc}} 
...
\end{DoxyReturn}
\mbox{\Hypertarget{scpi__uart_8c_a64d2478f69302269dd2157554ccdd1eb}\label{scpi__uart_8c_a64d2478f69302269dd2157554ccdd1eb}} 
...
{\footnotesize\ttfamily uint8\+\_\+t scpi\+\_\+uart\+\_\+write\+\_\+data (\begin{DoxyParamCaption}\item[{char $\ast$}]{dwrt }\end{DoxyParamCaption})}



function to send data to uart without checking to receive data. The last charcater is saved for later. 


\begin{DoxyParams}{Parameters}
{\em dwrt} & string to write on the uart \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
uint8\+\_\+t Error code to success or error 
\end{DoxyReturn}
\mbox{\Hypertarget{scpi__uart_8c_aabf80ce27bfee69f06fb7d0d48d71279}\label{scpi__uart_8c_aabf80ce27bfee69f06fb7d0d48d71279}} 
...
{\footnotesize\ttfamily uint8\+\_\+t scpi\+\_\+uart\+\_\+write\+\_\+read\+\_\+data (\begin{DoxyParamCaption}\item[{char $\ast$}]{dwrt,  }\item[{char $\ast$}]{dread,  }\item[{size\+\_\+t}]{rsize }\end{DoxyParamCaption})}
...
\begin{DoxyParams}{Parameters}
{\em dwrt} & Pointer to the write buffer containing the data to be sent. \\
\hline
...
\mbox{\Hypertarget{scpi__uart_8c_ab5345a6829daaaaf13a7eafc26244b3a}\label{scpi__uart_8c_ab5345a6829daaaaf13a7eafc26244b3a}} 
\index{scpi\_uart.c@{scpi\_uart.c}!ucom@{ucom}}
\index{ucom@{ucom}!scpi\_uart.c@{scpi\_uart.c}}
\doxysubsubsection{\texorpdfstring{ucom}{ucom}}
{\footnotesize\ttfamily struct \mbox{\hyperlink{structuser__com}{user\+\_\+com}} ucom}
...
The structure {\ttfamily ucom} contains various configuration settings for the UART interface, including baud rate, parity, data bits, and other communication settings. This structure is initialized with default values. 