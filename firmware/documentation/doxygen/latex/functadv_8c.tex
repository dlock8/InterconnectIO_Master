...
2024
\end{DoxyDate}
This module contains all software functions to execute low level action on device ressource available on the board. The configuration eeprom is controlled by function on this module. A basic selftest of the board is also executed on this module
