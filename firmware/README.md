...
| ||
|COM:SERIAL:WRITE8   |\<svalues\>  |  send string, don't wait for answer
|COM:SERIAL:READ8?   | \<svalues\> |  send string, wait for answer
...
|COM:SERIAL:Timeout?||
| ||
|COM:SPI:WRIte[:{Byte\|Word]}]|\<data\> | Spi write
|COM:SPI:WRIte:REAd? |(\<data\>) \<value\>  | Write data first and read number of bytes 
|COM:SPI:REAd? |\<value\> | Spi read number of bytes
...
|COM:SPI:DATAbits? ||
|COM:SPI:Mode    {0\|1\|2\|3}  ||  mode 0: Cpol=0, CPha=0 
